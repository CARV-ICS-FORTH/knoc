...
import (
	...
	vke2e "github.com/CARV-ICS-FORTH/knoc/test/e2e"
...
const (
	...
	defaultNodeName  = "vkubelet-knoc-0"
)
...
func setup() error {
	fmt.Println("Setting up end-to-end test suite for knoc provider...")
	return nil
}

// Provider-specific teardown function
func teardown() error {
	fmt.Println("Tearing down end-to-end test suite for knoc provider...")
	return nil
}
